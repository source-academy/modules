// The default values. These values will likely change.

// Default values of canvas
export const DEFAULT_WIDTH: number = 400;
export const DEFAULT_HEIGHT: number = 400;
...
export const MIN_HEIGHT: number = 400;
export const MAX_WIDTH: number = 400;
export const MIN_WIDTH: number = 400;
export const MAX_SCALE: number = 100;
export const MIN_SCALE: number = 1;
export const MAX_FPS: number = 30;
export const MIN_FPS: number = 30;
