...
import Plotly, { type Data, type Layout, type PlotData, type SliderStep } from 'plotly.js-dist';
import {
  type Curve,
  CurvePlot,
...
import { Body, BoundingBox, QuadTree, euclidean_distance } from './n_body_functions';
