...
function demo3dScatterPlot(): void {
  ...
  var data_z1: Data = { z: z1, type: 'surface' };
  var data_z2: Data = { z: z2, showscale: false, opacity:0.9, type: 'surface' };
  var data_z3: Data = { z: z3, showscale: false, opacity:0.9, type: 'surface' };
