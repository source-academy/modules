/* eslint-disable @typescript-eslint/naming-convention, @typescript-eslint/no-use-before-define, @typescript-eslint/no-unused-vars, prettier/prettier, no-plusplus */
/* prettier-ignore */
/*
