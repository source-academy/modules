...
Each Source module bundle is passed through `esbuild`, which converts it into an [IIFE](https://developer.mozilla.org/en-US/docs/Glossary/IIFE). Here is the `curve` module passed through `esbuild`:
