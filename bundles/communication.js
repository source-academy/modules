export default require => {
        ...
        return (function () {
          ...
          1: [function (require2, module3, exports3) {
            (function (process2, global2) {
              (function () {
                ...
                const nextTick = process2 ? process2.nextTick : function (callback) {
              ...
              my.onSocketMessage(function (res) {
                if (typeof res.data === "string") {
                  ...
                  reader.addEventListener("load", function () {
                    ...
                    if (data instanceof ArrayBuffer) data = Buffer2.from(data); else data = Buffer2.from(data, "utf8");
                    proxy.push(data);
                  });
          ...
          5: [function (require2, module3, exports3) {
            (function (process2) {
              (function () {
                ...
                const IS_BROWSER = typeof process2 !== "undefined" && process2.title === "browser" || typeof __webpack_require__ === "function";
                function buildUrl(opts, client) {
          ...
          12: [function (require2, module3, exports3) {
            (function (process2) {
              (function () {
                ...
                const protocols = {};
                if (typeof process2 !== "undefined" && process2.title !== "browser" || typeof __webpack_require__ !== "function") {
            ...
            (function (process2, Buffer2) {
              (function () {
                ...
                var onuncork = function (self2, fn) {
                  if (self2._corked) self2.once("uncork", fn); else fn();
                };
                ...
                var destroyer = function (self2, end2) {
                  return function (err) {
                    if (err) autoDestroy(self2, err.message === "premature close" ? null : err); else if (end2 && !self2._ended) self2.end();
                  };
                };
                ...
                Duplexify.prototype.setWritable = function (writable) {
                  ...
                  if (this._unwrite) process2.nextTick(ondrain);
              ...
              (function () {
                ...
                var eos = function (stream, opts, callback) {
                  ...
                  var onclose = function () {
                    process2.nextTick(onclosenexttick);
                  };
          ...
          22: [function (require2, module3, exports3) {
            ...
            function emitNone(handler, isFn, self2) {
              if (isFn) handler.call(self2); else {
            ...
            function emitOne(handler, isFn, self2, arg1) {
              if (isFn) handler.call(self2, arg1); else {
                var len = handler.length;
                var listeners = arrayClone(handler, len);
            ...
            function emitTwo(handler, isFn, self2, arg1, arg2) {
              if (isFn) handler.call(self2, arg1, arg2); else {
                var len = handler.length;
                var listeners = arrayClone(handler, len);
            ...
            function emitThree(handler, isFn, self2, arg1, arg2, arg3) {
              if (isFn) handler.call(self2, arg1, arg2, arg3); else {
                var len = handler.length;
                var listeners = arrayClone(handler, len);
            ...
            function emitMany(handler, isFn, self2, args) {
              if (isFn) handler.apply(self2, args); else {
                var len = handler.length;
                var listeners = arrayClone(handler, len);
            ...
            function functionBindPolyfill(context2) {
              var fn = this;
              return function () {
          ...
          25: [function (require2, module3, exports3) {
            ...
            var TreeNode = (function () {
              ...
              TreeNode2.prototype.remove = function () {
                ...
                if (this.parent) {
                  if (this === this.parent.leftChild) this.parent.leftChild = void 0; else if (this === this.parent.rightChild) this.parent.rightChild = void 0;
                }
                if (this.brother) this.brother.brother = void 0;
                this.key = void 0;
                this.value = void 0;
                this.parent = void 0;
                this.brother = void 0;
                  ...
                  return __generator(this, function (_a) {
                    switch (_a.label) {
                      ...
                      case 5:
                        ...
                        _a.label = 6;
                      case 6:
                        if (!(i < Deque.bucketSize)) return [3, 9];
                        return [4, map[first][i]];
                      case 7:
                        _a.sent();
                        _a.label = 8;
                      ...
                      case 9:
                        ...
                        _a.label = 10;
                      case 10:
                        if (!(i < last)) return [3, 15];
                        j = 0;
                        _a.label = 11;
                      case 11:
                        if (!(j < Deque.bucketSize)) return [3, 14];
                        return [4, map[i][j]];
                      case 12:
                        _a.sent();
                        _a.label = 13;
          ...
          27: [function (require2, module3, exports3) {
            ...
            function HashMap(container, initBucketNum, hashFunc) {
              ...
              var reAllocate = function (originalBucketNum) {
                ...
                hashTable.forEach(function (container2, index) {
                  ...
                  if (container2 instanceof LinkList_1.default && container2.size() === 1) {
                    ...
                    if (lowList_1.size() > HashMap.untreeifyThreshold) newHashTable[index] = new Map_1.default(lowList_1); else if (lowList_1.size()) newHashTable[index] = lowList_1;
                    if (highList_1.size() > HashMap.untreeifyThreshold) newHashTable[index + originalBucketNum] = new Map_1.default(highList_1); else if (highList_1.size()) newHashTable[index + originalBucketNum] = highList_1;
                  } else {
              ...
              this.getElementByKey = function (key) {
                var e_3, _a;
                var index = hashFunc(key) & bucketNum - 1;
                if (!hashTable[index]) return void 0;
                if (hashTable[index] instanceof Map_1.default) return hashTable[index].getElementByKey(key); else {
                  try {
                    for (var _b = __values(hashTable[index]), _c = _b.next(); !_c.done; _c = _b.next()) {
                      var pair = _c.value;
              ...
              this.find = function (key) {
                ...
                if (hashTable[index] instanceof Map_1.default) return hashTable[index].find(key);
                try {
                  for (var _b = __values(hashTable[index]), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var pair = _c.value;
                  ...
                  return __generator(this, function (_d) {
                    switch (_d.label) {
                      case 0:
                        ...
                        _d.label = 1;
                      case 1:
                        if (!(index < bucketNum)) return [3, 10];
              ...
              var reAllocate = function (originalBucketNum) {
                ...
                hashTable.forEach(function (container2, index) {
                  ...
                  if (container2 instanceof LinkList_1.default && container2.size() === 1) {
                    ...
                    if (element === void 0) throw new Error("unknown error");
                    ...
                    container2.forEach(function (element2) {
                      ...
                      } else highList_1.pushBack(element2);
                    });
                    if (lowList_1.size() > HashSet.untreeifyThreshold) newHashTable[index] = new Set_1.default(lowList_1); else if (lowList_1.size()) newHashTable[index] = lowList_1;
                    if (highList_1.size() > HashSet.untreeifyThreshold) newHashTable[index + originalBucketNum] = new Set_1.default(highList_1); else if (highList_1.size()) newHashTable[index + originalBucketNum] = highList_1;
                  } else {
                    var lowList_2 = new LinkList_1.default();
                    var highList_2 = new LinkList_1.default();
                    container2.forEach(function (element2) {
                      ...
                      } else highList_2.pushBack(element2);
                    });
                    if (lowList_2.size()) newHashTable[index] = lowList_2;
                    if (highList_2.size()) newHashTable[index + originalBucketNum] = highList_2;
                  }
          ...
          29: [function (require2, module3, exports3) {
            ...
            function LinkList(container) {
              ...
              this.forEach = function (callback) {
                ...
                var index = 0;
                while (curNode) {
                  if (curNode.value === void 0) throw new Error("unknown error");
              ...
              this.getElementByPos = function (pos) {
                ...
                if (!curNode || curNode.value === void 0) throw new Error("unknown error");
          ...
          30: [function (require2, module3, exports3) {
            ...
            function Map2(container, cmp) {
              ...
              var findSubTreeMinNode = function (curNode) {
                if (!curNode || curNode.key === void 0) throw new Error("unknown error");
              ...
              this.front = function () {
                ...
                if (minNode.key === void 0 || minNode.value === void 0) throw new Error("unknown error");
                return {
                  key: minNode.key,
                  value: minNode.value
                };
              ...
              this.back = function () {
                ...
                if (maxNode.key === void 0 || maxNode.value === void 0) throw new Error("unknown error");
                return {
                  key: maxNode.key,
                  value: maxNode.value
                };
              ...
              var _lowerBound = function (curNode, key) {
                if (!curNode || curNode.key === void 0 || curNode.value === void 0) return void 0;
                ...
                if (curNode === parentNode.leftChild) {
                  if (brotherNode.color === TreeNode_1.default.TreeNodeColorType.red) {
                    ...
                    if (brotherNode.rightChild && brotherNode.rightChild.color === TreeNode_1.default.TreeNodeColorType.red) {
                      ...
                      if (brotherNode.rightChild) brotherNode.rightChild.color = TreeNode_1.default.TreeNodeColorType.black;
                      var newRoot = parentNode.rotateLeft();
                      if (root === parentNode) root = newRoot;
                      curNode.color = TreeNode_1.default.TreeNodeColorType.black;
                      ...
                      if (brotherNode.leftChild) brotherNode.leftChild.color = TreeNode_1.default.TreeNodeColorType.black;
              ...
              var inOrderTraversal = function (curNode, callback) {
                if (!curNode || curNode.key === void 0) return false;
              ...
              this.eraseElementByKey = function (key) {
                ...
                if (curNode === void 0 || curNode.key === void 0 || cmp(curNode.key, key) !== 0) return;
                eraseNode(curNode);
              };
              ...
              var insertNodeSelfBalance = function (curNode) {
                ...
                if (parentNode.color === TreeNode_1.default.TreeNodeColorType.black) return;
              ...
              var findElementPos = function (curNode, element) {
                if (!curNode || curNode.key === void 0) return void 0;
                var cmpResult = cmp(element, curNode.key);
              ...
              this.getElementByKey = function (element) {
                ...
                if ((curNode === null || curNode === void 0 ? void 0 : curNode.key) === void 0 || (curNode === null || curNode === void 0 ? void 0 : curNode.value) === void 0) throw new Error("unknown error");
                return curNode.value;
              };
              ...
              var iterationFunc = function (curNode) {
                return __generator(this, function (_a) {
                  switch (_a.label) {
                    case 0:
                      if (!curNode || curNode.key === void 0 || curNode.value === void 0) return [2];
          ...
          33: [function (require2, module3, exports3) {
            ...
            function Set2(container, cmp) {
              ...
              this.eraseElementByValue = function (value) {
                ...
                if (curNode === void 0 || curNode.key === void 0 || cmp(curNode.key, value) !== 0) return;
                eraseNode(curNode);
              };
              var findInsertPos = function (curNode, element) {
                if (!curNode || curNode.key === void 0) throw new Error("unknown error");
              ...
              this.insert = function (element) {
                ...
                if (curNode.key !== void 0 && cmp(curNode.key, element) === 0) return;
                ++len;
                curNode.key = element;
                insertNodeSelfBalance(curNode);
                root.color = TreeNode_1.default.TreeNodeColorType.black;
              ...
              var iterationFunc = function (curNode) {
                return __generator(this, function (_a) {
                  switch (_a.label) {
                    case 0:
                      if (!curNode || curNode.key === void 0) return [2];
                      return [5, __values(iterationFunc(curNode.leftChild))];
                    case 1:
                      _a.sent();
                ...
                class Accumulator extends EventEmitter {
                  ...
                  concat() {
                    ...
                    for (i = 0; i < list.length && list[i] !== void 0; i++) {
                      if (typeof list[i] !== "string") lengths[i] = list[i].length; else lengths[i] = Buffer2.byteLength(list[i]);
                      length += lengths[i];
                    }
            ...
            (function (Buffer2) {
              (function () {
                ...
                function publish(packet, stream, opts) {
                  ...
                  const properties = settings.properties;
                  let length = 0;
                  if (typeof topic === "string") length += Buffer2.byteLength(topic) + 2; else if (Buffer2.isBuffer(topic)) length += topic.length + 2; else {
                    stream.emit("error", new Error("Invalid topic"));
                    return false;
                  }
                  if (!Buffer2.isBuffer(payload)) length += Buffer2.byteLength(payload); else length += payload.length;
                ...
                function byteLength(bufOrString) {
                  if (!bufOrString) return 0; else if (bufOrString instanceof Buffer2) return bufOrString.length; else return Buffer2.byteLength(bufOrString);
                }
            ...
            (function (process2, global2) {
              (function () {
                ...
                Readable.prototype.pipe = function (dest, pipeOpts) {
                  ...
                  if (state.endEmitted) process2.nextTick(endFn); else src.once("end", endFn);
                ...
                Readable.prototype.wrap = function (stream) {
                  ...
                  stream.on("data", function (chunk) {
                    ...
                    if (state.objectMode && (chunk === null || chunk === void 0)) return; else if (!state.objectMode && (!chunk || !chunk.length)) return;
            ...
            (function (process2, global2) {
              (function () {
                ...
                function endWritable(stream, state, cb) {
                  ...
                  finishMaybe(stream, state);
                  if (cb) {
                    if (state.finished) process2.nextTick(cb); else stream.once("finish", cb);
                  }
                  state.ended = true;
          ...
          70: [function (require2, module3, exports3) {
            "use strict";
            function ReInterval(callback, interval2, args) {
              var self2 = this;
              this._callback = callback;
              this._args = args;
              this._interval = setInterval(callback, interval2, this._args);
              this.reschedule = function (interval3) {
                if (!interval3) interval3 = self2._interval;
                if (self2._interval) clearInterval(self2._interval);
                self2._interval = setInterval(self2._callback, interval3, self2._args);
              };
              this.clear = function () {
                if (self2._interval) {
          ...
          75: [function (require2, module3, exports3) {
            ...
            function utf8CheckIncomplete(self2, buf, i) {
              ...
              if (nb >= 0) {
                if (nb > 0) {
                  if (nb === 2) nb = 0; else self2.lastNeed = nb - 3;
                }
                return nb;
              }
              return 0;
  ...
  __export(communication_exports, {
    ...
    getUserId: () => getUserId,
    initCommunications: () => initCommunications,
  ...
  init_define_process();
  init_define_process();
  var import_mqtt = __toESM(require_mqtt(), 1);
  var STATE_CONNECTED = "Connected";
  var STATE_DISCONNECTED = "Disconnected";
  var STATE_RECONNECTING = "Reconnecting";
  var STATE_OFFLINE = "Offline";
  var MqttController = class {
    constructor(connectionCallback, messageCallback) {
      this.client = null;
      this.address = "";
      this.port = 443;
      this.user = "";
    ...
    publish(topic, message, isRetain, qos = 1) {
      var _a;
      (_a = this.client) == null ? void 0 : _a.publish(topic, message, {
        qos,
        retain: isRetain
      });
    }
    ...
    unsubscribe(topic) {
      var _a;
      (_a = this.client) == null ? void 0 : _a.unsubscribe(topic);
    }
  };
  init_define_process();
  ...
  var GlobalStateController = class {
    ...
    parseGlobalStateMessage(shortenedTopic, message) {
      ...
      try {
        let newGlobalState = __spreadValues({}, this.globalState);
        if (this.globalState instanceof Array || typeof this.globalState === "string") {
          newGlobalState = {};
        }
        let currentJson = newGlobalState;
        for (let i = 1; i < splitTopic.length - 1; i++) {
          const subTopic = splitTopic[i];
          if (!(currentJson[subTopic] instanceof Object) || currentJson[subTopic] instanceof Array || typeof currentJson[subTopic] === "string") {
    ...
    updateGlobalState(path, updatedState) {
      var _a;
      if (this.topicHeader.length === 0) return;
  ...
  var RpcController = class {
    constructor(topicHeader, multiUser, userId) {
      this.functions = new Map();
      this.pendingReturns = new Map();
      this.topicHeader = topicHeader;
      this.multiUser = multiUser;
      this.userId = userId != null ? userId : (0, import_uniqid.default)();
    ...
    returnResponse(sender, callId, result) {
      ...
      (_a = this.multiUser.controller) == null ? void 0 : _a.publish(topic, JSON.stringify(message), false);
    }
    getUserId() {
      return this.userId;
    }
    expose(name, func) {
      ...
      this.multiUser.addMessageCallback(functionTopic, (topic, message) => {
        ...
        try {
          const result = calledFunc == null ? void 0 : calledFunc.func(...parsedMessage.args);
    ...
    callFunction(receiver, name, args, callback) {
      var _a;
      const topic = `${this.topicHeader}/${receiver}/${name}`;
      const callId = (0, import_uniqid.default)();
      ...
      (_a = this.multiUser.controller) == null ? void 0 : _a.publish(topic, messageString, false);
    }
  };
  var CommunicationModuleState = class {
  ...
  function keepRunning() {
    interval = window.setInterval(() => {}, 2e4);
  }
