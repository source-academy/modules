(function (_react, ReactDOM) {
  ...
  return (() => {
    ...
    var Handle = (function (_super) {
      ...
      Handle2.prototype.render = function () {
        ...
        return React16.createElement("span", __assign({
          ...
          className: (0, import_classnames6.default)(classes_exports.SLIDER_HANDLE, (_a3 = {}, _a3[classes_exports.ACTIVE] = isMoving, _a3), className),
    ...
    var MultiItemDisplay = props => {
      const [currentStep, setCurrentStep] = import_react6.default.useState(0);
      ...
      }, props.elements.length > 1 ? import_react6.default.createElement("div", {
        style: {
          display: "flex",
          justifyContent: "center",
          alignItems: "center",
      ...
      }, "Previous"), import_react6.default.createElement("h3", {
        className: "bp3-text-large"
      }, "Call ", currentStep + 1, "/", props.elements.length), import_react6.default.createElement(Button, {
        style: {
          position: "absolute",
          right: 0
        },
      ...
      }, "Next")) : null, import_react6.default.createElement("div", {
        style: {
          width: "100%",
          paddingLeft: "20px",
          paddingRight: "20px",
    ...
    var multi_item_display_default = MultiItemDisplay;
    init_define_process();
    init_define_process();
    init_define_process();
    ...
    var WebGLCanvas = import_react7.default.forwardRef((props, ref) => {
      ...
      return import_react7.default.createElement("canvas", __spreadProps(__spreadValues({}, props), {
        style,
        ref,
        height: 512,
        width: 512
    ...
    var Curve3DAnimationCanvas = class extends import_react8.default.Component {
      ...
      render() {
        const buttons = import_react8.default.createElement("div", {
          style: {
            marginLeft: "20px",
            marginRight: "20px",
            marginTop: "5px",
        ...
        }, import_react8.default.createElement(Tooltip2, {
        ...
        const sliders = import_react8.default.createElement("div", {
          style: {
            flexGrow: 1,
            display: "flex",
            flexDirection: "column",
        ...
        }, import_react8.default.createElement(Slider, {
        ...
        return import_react8.default.createElement(import_react8.default.Fragment, null, import_react8.default.createElement("div", {
          style: {
            display: "flex",
            alignContent: "center",
            justifyContent: "center"
          }
        }, import_react8.default.createElement(webgl_canvas_default, {
          style: {
            flexGrow: 1
          },
          ref: r => {
        ...
        }, buttons, sliders, import_react8.default.createElement(Switch, {
          style: {
            marginLeft: "20px",
            marginRight: "20px",
            marginTop: "10px",
    ...
    var CurveCanvas3D = class extends import_react9.default.Component {
      ...
      render() {
        ...
        }, import_react9.default.createElement(webgl_canvas_default, {
          ref: r => {
            this.$canvas = r;
          }
        ...
        }, import_react9.default.createElement(Slider, {
    ...
    var AnimationCanvas = class extends import_react10.default.Component {
      ...
      render() {
        const buttons = import_react10.default.createElement("div", {
          style: {
            marginLeft: "20px",
            marginRight: "20px",
            display: "flex",
        ...
        }, import_react10.default.createElement(Tooltip2, {
          content: this.state.isPlaying ? "Pause" : "Play"
        ...
        const animSlider = import_react10.default.createElement("div", {
          style: {
            marginTop: "7px",
            flexGrow: 1
          }
        }, import_react10.default.createElement(Slider, {
          value: this.state.animTimestamp,
        ...
        return import_react10.default.createElement(import_react10.default.Fragment, null, import_react10.default.createElement("div", {
          style: {
            display: "flex",
            alignContent: "center",
            justifyContent: "center"
          }
        }, import_react10.default.createElement(webgl_canvas_default, {
          style: {
            flexGrow: 1
          },
          ref: r => {
        ...
        }, buttons, animSlider, import_react10.default.createElement(Switch, {
          style: {
            marginLeft: "20px",
            marginRight: "20px",
            marginTop: "5px",
    ...
    var Curve_default = {
      toSpawn(context) {
        var _a3, _b2, _c2, _d2;
        const drawnCurves = (_d2 = (_c2 = (_b2 = (_a3 = context.context) == null ? void 0 : _a3.moduleContexts) == null ? void 0 : _b2.curve) == null ? void 0 : _c2.state) == null ? void 0 : _d2.drawnCurves;
      ...
      body(context) {
        ...
        const canvases = drawnCurves.map((curve, i) => {
          ...
          if (glAnimation.isAnimation(curve)) {
            const anim = curve;
            return anim.is3D ? import_react11.default.createElement(Curve3DAnimationCanvas, {
              animation: anim,
              key: elemKey
            }) : import_react11.default.createElement(AnimationCanvas, {
              animation: anim,
              key: elemKey
            });
          }
          const curveDrawn = curve;
          return curveDrawn.is3D() ? import_react11.default.createElement(CurveCanvas3D, {
            curve: curveDrawn,
            key: elemKey
          }) : import_react11.default.createElement(webgl_canvas_default, {
            ref: r => {
              if (r) {
                curveDrawn.init(r);
                curveDrawn.redraw(0);
        ...
        return import_react11.default.createElement(multi_item_display_default, {
          elements: canvases
        });
      },
      label: "Curves Tab",
