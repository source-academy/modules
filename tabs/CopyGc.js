(function (_react, ReactDOM) {
  ...
  return (() => {
    ...
    var CopyGC = class extends import_react.default.Component {
      ...
      render() {
        ...
        if (state.running) {
          ...
          const lengthOfFunction = this.getlengthFunction();
          return import_react.default.createElement("div", null, import_react.default.createElement("div", null, import_react.default.createElement("p", null, "This is a visualiser for stop and copy garbage collector. Check the guide", " ", import_react.default.createElement("a", {
          ...
          }), import_react.default.createElement("span", null, " ", state.leftDesc, " ")) : false, state.rightDesc ? import_react.default.createElement("div", {
            style: {
              flex: 1
            }
          }, import_react.default.createElement("canvas", {
          ...
          }))), import_react.default.createElement("div", null, import_react.default.createElement("div", null, import_react.default.createElement("h3", null, state.toSpace === 0 ? "To Space" : "From Space"), import_react.default.createElement("div", null, toMemoryMatrix && toMemoryMatrix.length > 0 && toMemoryMatrix.map((item, row) => import_react.default.createElement("div", {
            style: {
              display: "flex",
              flexDirection: "row"
            }
          ...
          }))))), import_react.default.createElement("div", null, import_react.default.createElement("h3", null, state.toSpace > 0 ? "To Space" : "From Space"), import_react.default.createElement("div", null, fromMemoryMatrix && fromMemoryMatrix.length > 0 && fromMemoryMatrix.map((item, row) => import_react.default.createElement("div", {
            style: {
              display: "flex",
              flexDirection: "row"
            }
          ...
          }, row * state.column + state.memorySize / 2), item && item.length > 0 ? item.map(content => {
            const color = this.getMemoryColor(content);
            const bgColor = this.getBackgroundColor(content);
            return import_react.default.createElement("div", {
              style: {
          ...
          }) : false))))), import_react.default.createElement("div", {
            style: {
              display: "flex",
              flexDirection: "row",
              marginTop: 10
          ...
          }), import_react.default.createElement("span", null, " empty or undefined"))));
        }
        return import_react.default.createElement("div", null, import_react.default.createElement("p", null, "This is a visualiser for stop and copy garbage collector. Check the guide", " ", import_react.default.createElement("a", {
          href: "https://github.com/source-academy/modules/wiki/%5Bcopy_gc-&-mark_sweep%5D-User-Guide"
    ...
    var CopyGc_default = {
      toSpawn: () => true,
      body: debuggerContext => import_react.default.createElement(CopyGC, {
        debuggerContext
      }),
