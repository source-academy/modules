export default require => (() => {
  ...
  var require_b2_draw_helper = __commonJS({
    "node_modules/@box2d/core/dist/common/b2_draw_helper.js"(exports) {
      ...
      function DrawShapes2(draw, world, within) {
  ...
  var require_dist2 = __commonJS({
    "node_modules/@box2d/debug-draw/dist/index.js"(exports) {
      ...
      var DebugDraw2 = class _DebugDraw {
        constructor(ctx) {
        ...
        DrawPolygon(vertices, vertexCount, color) {
          ...
          this.ctx.closePath();
          this.ctx.strokeStyle = _DebugDraw.MakeStyleString(color, 1);
          this.ctx.stroke();
        }
        DrawSolidPolygon(vertices, vertexCount, color) {
          ...
          this.ctx.closePath();
          this.ctx.fillStyle = _DebugDraw.MakeStyleString(color, 0.5);
          this.ctx.fill();
          this.ctx.strokeStyle = _DebugDraw.MakeStyleString(color, 1);
          this.ctx.stroke();
        }
        ...
        DrawParticles(centers, radius, colors, count) {
          if (colors) {
            for (let i = 0; i < count; ++i) {
              ...
              this.ctx.fillStyle = _DebugDraw.MakeStyleString(color);
              this.ctx.beginPath();
              this.ctx.arc(center.x, center.y, radius, 0, Math.PI * 2, true);
              this.ctx.fill();
            }
        ...
        DrawTransform(xf) {
          ...
          this.ctx.moveTo(0, 0);
          this.ctx.lineTo(1, 0);
          this.ctx.strokeStyle = _DebugDraw.MakeStyleString(core_1.b2Color.RED);
          this.ctx.stroke();
          this.ctx.beginPath();
          this.ctx.moveTo(0, 0);
          this.ctx.lineTo(0, 1);
          this.ctx.strokeStyle = _DebugDraw.MakeStyleString(core_1.b2Color.GREEN);
          this.ctx.stroke();
        ...
        DrawString(x, y, align, message) {
          ...
          this.ctx.fillStyle = _DebugDraw.MakeStyleString(core_1.b2Color.WHITE);
        ...
        DrawStringWorld(x, y, message) {
          ...
          this.ctx.fillStyle = _DebugDraw.MakeStyleString(COLOR_STRING_WORLD);
          this.ctx.fillText(message, vx, vy);
          this.ctx.restore();
        }
        DrawAABB(aabb, color) {
          this.ctx.strokeStyle = _DebugDraw.MakeStyleString(color);
  ...
  var WebGLCanvas = import_react.default.forwardRef((props, ref) => {
