  ...
  return (() => {
    ...
    var ControlGroup = (function (_super) {
      ...
      ControlGroup2.prototype.render = function () {
        var _a3;
        var _b2 = this.props, children = _b2.children, className = _b2.className, elementRef = _b2.elementRef, fill = _b2.fill, vertical = _b2.vertical, htmlProps = __rest(_b2, ["children", "className", "elementRef", "fill", "vertical"]);
        var rootClasses = (0, import_classnames5.default)(classes_exports.CONTROL_GROUP, (_a3 = {}, _a3[classes_exports.FILL] = fill, _a3[classes_exports.VERTICAL] = vertical, _a3), className);
        return React8.createElement("div", __assign({}, htmlProps, {
          className: rootClasses,
          ref: elementRef
        }), children);
      };
      ControlGroup2.displayName = ("").concat(DISPLAYNAME_PREFIX, ".ControlGroup");
    ...
    var AsyncControllableInput = (function (_super) {
      ...
      function AsyncControllableInput2() {
        ...
        _this.handleCompositionStart = function (e) {
          var _a3, _b2, _c2;
          (_a3 = _this.cancelPendingCompositionEnd) === null || _a3 === void 0 ? void 0 : _a3.call(_this);
          _this.setState({
            isComposing: true
          });
          (_c2 = (_b2 = _this.props).onCompositionStart) === null || _c2 === void 0 ? void 0 : _c2.call(_b2, e);
        };
        _this.handleCompositionEnd = function (e) {
          ...
          (_b2 = (_a3 = _this.props).onCompositionEnd) === null || _b2 === void 0 ? void 0 : _b2.call(_a3, e);
        };
        _this.handleChange = function (e) {
          ...
          (_b2 = (_a3 = _this.props).onChange) === null || _b2 === void 0 ? void 0 : _b2.call(_a3, e);
        };
        return _this;
      }
    ...
    var InputGroup = (function (_super) {
      ...
      InputGroup2.prototype.componentDidUpdate = function (prevProps) {
        var _a3 = this.props, leftElement = _a3.leftElement, rightElement = _a3.rightElement;
      ...
      InputGroup2.prototype.updateInputWidth = function () {
        var _a3 = this.state, leftElementWidth = _a3.leftElementWidth, rightElementWidth = _a3.rightElementWidth;
    ...
    var NumericInput = (function (_super) {
      ...
      function NumericInput2() {
        ...
        _this.numericInputId = utils_exports.uniqueId("numericInput");
        _this.state = {
          currentImeInputInvalid: false,
          shouldSelectAfterUpdate: false,
          stepMaxPrecision: NumericInput2.getStepMaxPrecision(_this.props),
          value: getValueOrEmptyValue((_a3 = _this.props.value) !== null && _a3 !== void 0 ? _a3 : _this.props.defaultValue)
        };
        ...
        _this.handleButtonClick = function (e, direction) {
          ...
          (_b2 = (_a4 = _this.props).onButtonClick) === null || _b2 === void 0 ? void 0 : _b2.call(_a4, Number(parseStringToStringNumber(nextValue, _this.props.locale)), nextValue);
        };
        ...
        _this.handleContinuousChange = function () {
          ...
          if (_this.props.min !== void 0 || _this.props.max !== void 0) {
            var min = (_a4 = _this.props.min) !== null && _a4 !== void 0 ? _a4 : -Infinity;
            var max = (_b2 = _this.props.max) !== null && _b2 !== void 0 ? _b2 : Infinity;
          ...
          (_d2 = (_c2 = _this.props).onButtonClick) === null || _d2 === void 0 ? void 0 : _d2.call(_c2, Number(parseStringToStringNumber(nextValue, _this.props.locale)), nextValue);
        };
        _this.handleInputFocus = function (e) {
          ...
          (_b2 = (_a4 = _this.props).onFocus) === null || _b2 === void 0 ? void 0 : _b2.call(_a4, e);
        };
        _this.handleInputBlur = function (e) {
          ...
          (_b2 = (_a4 = _this.props).onBlur) === null || _b2 === void 0 ? void 0 : _b2.call(_a4, e);
        };
        _this.handleInputKeyDown = function (e) {
          ...
          var direction;
          if (keyCode === keys_exports.ARROW_UP) {
            direction = IncrementDirection.UP;
          } else if (keyCode === keys_exports.ARROW_DOWN) {
          ...
          (_b2 = (_a4 = _this.props).onKeyDown) === null || _b2 === void 0 ? void 0 : _b2.call(_a4, e);
        };
        _this.handleCompositionEnd = function (e) {
        ...
        _this.handleInputKeyPress = function (e) {
          ...
          (_b2 = (_a4 = _this.props).onKeyPress) === null || _b2 === void 0 ? void 0 : _b2.call(_a4, e);
        };
        _this.handleInputPaste = function (e) {
          var _a4, _b2;
          _this.didPasteEventJustOccur = true;
          (_b2 = (_a4 = _this.props).onPaste) === null || _b2 === void 0 ? void 0 : _b2.call(_a4, e);
        };
      ...
      NumericInput2.getDerivedStateFromProps = function (props, state) {
        ...
        var value = (_b2 = (_a3 = props.value) === null || _a3 === void 0 ? void 0 : _a3.toString()) !== null && _b2 !== void 0 ? _b2 : state.value;
      ...
      NumericInput2.getStepMaxPrecision = function (props) {
        if (props.minorStepSize != null) {
          return utils_exports.countDecimalPlaces(props.minorStepSize);
        } else {
          return utils_exports.countDecimalPlaces(props.stepSize);
        }
      };
      ...
      NumericInput2.prototype.componentDidUpdate = function (prevProps, prevState) {
        ...
        if (this.state.shouldSelectAfterUpdate) {
          (_a3 = this.inputElement) === null || _a3 === void 0 ? void 0 : _a3.setSelectionRange(0, this.state.value.length);
        }
        ...
        if (didBoundsChange && didValueChange || didLocaleChange && prevState.value !== NumericInput2.VALUE_EMPTY) {
          ...
          (_c2 = (_b2 = this.props).onValueChange) === null || _c2 === void 0 ? void 0 : _c2.call(_b2, +valueAsString, localizedValue, this.inputElement);
        }
      };
      ...
      NumericInput2.prototype.renderButtons = function () {
        var _a3 = this.props, intent = _a3.intent, max = _a3.max, min = _a3.min, locale = _a3.locale;
      ...
      NumericInput2.prototype.renderInput = function () {
        ...
        return React11.createElement(InputGroup, __assign({
          ...
          role: this.props.allowNumericCharactersOnly ? "spinbutton" : void 0
        }, inputGroupHtmlProps, {
      ...
      NumericInput2.prototype.getButtonEventHandlers = function (direction) {
        ...
        return {
          onKeyDown: function (evt) {
            if (!_this.props.disabled && keys_exports.isKeyboardClick(evt.keyCode)) {
      ...
      NumericInput2.prototype.handleNextValue = function (valueAsString) {
        ...
        (_b2 = (_a3 = this.props).onValueChange) === null || _b2 === void 0 ? void 0 : _b2.call(_a3, Number(parseStringToStringNumber(valueAsString, this.props.locale)), valueAsString, this.inputElement);
      };
      ...
      NumericInput2.prototype.getIncrementDelta = function (direction, isShiftKeyPressed, isAltKeyPressed) {
        var _a3 = this.props, majorStepSize = _a3.majorStepSize, minorStepSize = _a3.minorStepSize, stepSize = _a3.stepSize;
      ...
      NumericInput2.prototype.updateDelta = function (direction, e) {
    ...
    var UnityComponent = class extends import_react.default.Component {
      render() {
        ...
        }, "Preparing to load Unity Academy...")), import_react.default.createElement("div", {
          id: "unity-container"
    ...
    var Unity3DTab = class extends import_react2.default.Component {
      render() {
        ...
        if (currentTargetFrameRate > 30 && currentTargetFrameRate <= 60) {
          highFPSWarning = import_react2.default.createElement("div", {
            style: {
              color: "yellow"
            }
          }, "[Warning] You are trying to set target fps higher than default value (30). Higher FPS will lead to more cost in your device's resources such as GPU, increace device temperature and battery usage and may even lead to browser not responding, crash the browser or even crash your operation system if your device really can not endure the high resource cost.");
        } else if (currentTargetFrameRate > 60 && currentTargetFrameRate <= 120) {
          highFPSWarning = import_react2.default.createElement("div", {
            style: {
              color: "red"
            }
          }, "[!!WARNING!!] You are trying to set target fps that is extremely high. This FPS may lead to large cost in your device's resources such as GPU, significantly increace device temperature and battery usage and have a large chance of making browser not responding, crash the browser or even crash your operation system if your device's performance is not enough.", import_react2.default.createElement("br", null), import_react2.default.createElement("br", null), " ***ARE YOU REALLY CONFIDENT ABOUT THE PERFORMANCE OF YOUR OWN DEVICE?***");
        } else {
          highFPSWarning = import_react2.default.createElement("div", null);
        }
        const dimensionMode = getInstance().dimensionMode;
        return import_react2.default.createElement("div", null, import_react2.default.createElement("p", null, "Click the button below to open the Unity Academy Window filling the page."), import_react2.default.createElement("p", null, import_react2.default.createElement("b", null, "Current Mode: ", dimensionMode === "3d" ? "3D" : "2D")), import_react2.default.createElement("br", null), import_react2.default.createElement("p", null, import_react2.default.createElement("b", null, "Remember always terminate the Unity Academy application when you completely finish programming with this module"), " to clean up the engine and free up memory."), import_react2.default.createElement("p", null, "Otherwise it may lead to a potential waste to your device's resources (such as RAM) and battery."), import_react2.default.createElement("br", null), import_react2.default.createElement("p", null, "100% resolution will display Unity Academy in a larger area with more detailed graphics but requires higher GPU performance than 50% resolution."), import_react2.default.createElement(Button, {
        ...
        }), import_react2.default.createElement("br", null), import_react2.default.createElement(Button, {
          icon: IconNames.SEND_TO,
          active: true,
          onClick: () => {
        ...
        }), import_react2.default.createElement("br", null), import_react2.default.createElement("br", null), import_react2.default.createElement("p", null, "Target Frame Rate: "), import_react2.default.createElement(NumericInput, {
          style: {
            width: 100
          },
          ...
          stepSize: 1
        }), highFPSWarning, import_react2.default.createElement("br", null), import_react2.default.createElement("br", null), import_react2.default.createElement("div", null, "3D Prefab Information: ", import_react2.default.createElement("a", {
          href: `${UNITY_ACADEMY_BACKEND_URL}webgl_assetbundles/prefab_info.html`,
          rel: "noopener noreferrer",
          target: "_blank"
        }, "Click Here"), dimensionMode === "2d" && " (You need 3D mode to use prefabs.)"), import_react2.default.createElement("div", null, "Code Examples: ", import_react2.default.createElement("a", {
    ...
    var UnityAcademy_default = {
      ...
      body(_context) {
        return import_react2.default.createElement(Unity3DTab, null);
      },
      label: "Unity Academy",
      iconName: "cube"
    };
