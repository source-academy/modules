(function (_react, ReactDOM) {
  ...
  return (() => {
    ...
    var Handle = (function (_super) {
      ...
      function Handle2() {
        ...
        _this.getStyleProperties = function () {
          ...
          var _a2 = _this.props, _b2 = _a2.min, min = _b2 === void 0 ? 0 : _b2, tickSizeRatio = _a2.tickSizeRatio, value = _a2.value, vertical = _a2.vertical;
        ...
        _this.handleMoveEndedAt = function (clientPixel) {
          ...
          (_b2 = (_a2 = _this.props).onRelease) === null || _b2 === void 0 ? void 0 : _b2.call(_a2, finalValue);
        };
        ...
        _this.handleKeyDown = function (event) {
          var _a2 = _this.props, stepSize = _a2.stepSize, value = _a2.value;
        ...
        _this.handleKeyUp = function (event) {
          ...
          if ([keys_exports.ARROW_UP, keys_exports.ARROW_DOWN, keys_exports.ARROW_LEFT, keys_exports.ARROW_RIGHT].indexOf(event.which) >= 0) {
            (_b2 = (_a2 = _this.props).onRelease) === null || _b2 === void 0 ? void 0 : _b2.call(_a2, _this.props.value);
          }
        };
        return _this;
      }
      ...
      Handle2.prototype.render = function () {
        var _a2;
        var _b2 = this.props, className = _b2.className, disabled = _b2.disabled, label = _b2.label, min = _b2.min, max = _b2.max, value = _b2.value, vertical = _b2.vertical, htmlProps = _b2.htmlProps;
        var isMoving = this.state.isMoving;
        return React4.createElement("span", __assign({
          role: "slider",
          tabIndex: 0
        }, htmlProps, {
          className: (0, import_classnames2.default)(classes_exports.SLIDER_HANDLE, (_a2 = {}, _a2[classes_exports.ACTIVE] = isMoving, _a2), className),
        ...
        }), label == null ? null : React4.createElement("span", {
      ...
      Handle2.prototype.clientToValue = function (clientPixel) {
        var _a2 = this.props, stepSize = _a2.stepSize, tickSize = _a2.tickSize, value = _a2.value, vertical = _a2.vertical;
    ...
    var MultiSlider = (function (_super) {
      ...
      function MultiSlider2() {
        ...
        _this.handleChange = function (newValues) {
          ...
          if (!arraysEqual(newValues, oldValues)) {
            (_b2 = (_a2 = _this.props).onChange) === null || _b2 === void 0 ? void 0 : _b2.call(_a2, newValues);
            handleProps.forEach(function (handle, index) {
              var _a3;
              if (oldValues[index] !== newValues[index]) {
                (_a3 = handle.onChange) === null || _a3 === void 0 ? void 0 : _a3.call(handle, newValues[index]);
              }
            });
          }
        };
        _this.handleRelease = function (newValues) {
          var _a2, _b2;
          var handleProps = getSortedInteractiveHandleProps(_this.props);
          (_b2 = (_a2 = _this.props).onRelease) === null || _b2 === void 0 ? void 0 : _b2.call(_a2, newValues);
          handleProps.forEach(function (handle, index) {
            var _a3;
            (_a3 = handle.onRelease) === null || _a3 === void 0 ? void 0 : _a3.call(handle, newValues[index]);
          });
        };
        return _this;
      }
      ...
      MultiSlider2.getLabelPrecision = function (_a2) {
        var labelPrecision = _a2.labelPrecision, stepSize = _a2.stepSize;
      ...
      MultiSlider2.prototype.render = function () {
        var _a2;
        var _this = this;
        var classes = (0, import_classnames3.default)(classes_exports.SLIDER, (_a2 = {}, _a2[classes_exports.DISABLED] = this.props.disabled, _a2[("").concat(classes_exports.SLIDER, "-unlabeled")] = this.props.labelRenderer === false, _a2[classes_exports.VERTICAL] = this.props.vertical, _a2), this.props.className);
        ...
        }, this.renderTracks()), React5.createElement("div", {
      ...
      MultiSlider2.prototype.renderLabels = function () {
        ...
        var _a2 = this.props, max = _a2.max, min = _a2.min;
      ...
      MultiSlider2.prototype.renderTrackFill = function (index, start, end) {
        var _a2 = [this.getOffsetRatio(start.value), this.getOffsetRatio(end.value)].sort(function (left, right) {
          return left - right;
        }), startRatio = _a2[0], endRatio = _a2[1];
        ...
        var classes = (0, import_classnames3.default)(classes_exports.SLIDER_PROGRESS, classes_exports.intentClass(this.getTrackIntent(start, end)));
        return React5.createElement("div", {
      ...
      MultiSlider2.prototype.renderHandles = function () {
        var _this = this;
        var _a2 = this.props, disabled = _a2.disabled, max = _a2.max, min = _a2.min, stepSize = _a2.stepSize, vertical = _a2.vertical;
        var handleProps = getSortedInteractiveHandleProps(this.props);
        if (handleProps.length === 0) {
          return null;
        }
        return handleProps.map(function (_a3, index) {
          var _b2;
          var value = _a3.value, type = _a3.type, className = _a3.className, htmlProps = _a3.htmlProps;
          return React5.createElement(Handle, {
            htmlProps,
            className: (0, import_classnames3.default)((_b2 = {}, _b2[classes_exports.START] = type === HandleType.START, _b2[classes_exports.END] = type === HandleType.END, _b2), className),
            disabled,
      ...
      MultiSlider2.prototype.getLabelValues = function () {
        var _a2 = this.props, labelStepSize = _a2.labelStepSize, labelValues = _a2.labelValues, min = _a2.min, max = _a2.max;
        var values = [];
      ...
      MultiSlider2.prototype.getTrackIntent = function (start, end) {
        if (!this.props.showTrackFill) {
          return Intent.NONE;
        }
        if (start.intentAfter !== void 0) {
          return start.intentAfter;
        } else if (end !== void 0 && end.intentBefore !== void 0) {
    ...
    function getLabelPrecision(_a2) {
      var labelPrecision = _a2.labelPrecision, _b2 = _a2.stepSize, stepSize = _b2 === void 0 ? MultiSlider.defaultSliderProps.stepSize : _b2;
      return labelPrecision == null ? countDecimalPlaces(stepSize) : labelPrecision;
    }
    ...
    function getSortedHandleProps(_a2, predicate) {
      ...
      var maybeHandles = React5.Children.map(children, function (child) {
    ...
    var Slider = (function (_super) {
      ...
      Slider2.prototype.render = function () {
        var _a2 = this.props, initialValue = _a2.initialValue, intent = _a2.intent, value = _a2.value, onChange = _a2.onChange, onRelease = _a2.onRelease, handleHtmlProps = _a2.handleHtmlProps, props = __rest(_a2, ["initialValue", "intent", "value", "onChange", "onRelease", "handleHtmlProps"]);
        return React6.createElement(MultiSlider, __assign({}, props), React6.createElement(MultiSlider.Handle, {
          value,
        ...
        }), React6.createElement(MultiSlider.Handle, {
          value: initialValue,
    ...
    var MarkSweep = class extends import_react.default.Component {
      ...
      render() {
        ...
        if (state.running) {
          ...
          const lengthOfFunction = this.getlengthFunction();
          return import_react.default.createElement("div", null, import_react.default.createElement("div", null, import_react.default.createElement("p", null, "This is a visualiser for mark and sweep garbage collector. Check the guide", " ", import_react.default.createElement("a", {
            href: "https://github.com/source-academy/modules/wiki/%5Bcopy_gc-&-mark_sweep%5D-User-Guide"
          }, "here"), "."), import_react.default.createElement("h3", null, state.command), import_react.default.createElement("p", null, " ", state.description, " "), import_react.default.createElement("div", {
            style: {
              display: "flex",
              flexDirection: "row",
              marginTop: 10
            }
          }, state.leftDesc && import_react.default.createElement("div", {
            style: {
              flex: 1
            }
          ...
          }), import_react.default.createElement("span", null, " ", state.leftDesc, " ")), state.rightDesc ? import_react.default.createElement("div", {
            style: {
              flex: 1
            }
          }, import_react.default.createElement("canvas", {
          ...
          }), import_react.default.createElement("span", null, " ", state.rightDesc, " ")) : false), import_react.default.createElement("br", null), import_react.default.createElement("p", null, "Current step:", "   ", import_react.default.createElement(Icon, {
            icon: "remove",
            onClick: this.handleMinus
          }), "   ", state.value, "   ", import_react.default.createElement(Icon, {
            icon: "add",
          ...
          }))), import_react.default.createElement("div", null, import_react.default.createElement("div", null, import_react.default.createElement("div", null, memoryMatrix && memoryMatrix.length > 0 && memoryMatrix.map((item, row) => import_react.default.createElement("div", {
            style: {
              display: "flex",
              flexDirection: "row"
            }
          ...
          }, " ", row * state.column, " "), item && item.length > 0 && item.map(content => {
          ...
          })))), import_react.default.createElement("div", null, state.queue && state.queue.length && import_react.default.createElement("div", null, import_react.default.createElement("br", null), import_react.default.createElement("span", null, " Queue: ["), state.queue.map(child => import_react.default.createElement("span", {
            style: {
              fontSize: 10
            }
          }, " ", child, ", ")), import_react.default.createElement("span", null, " ] ")))), import_react.default.createElement("div", {
            style: {
              display: "flex",
              flexDirection: "row",
              marginTop: 10
          ...
          }), import_react.default.createElement("span", null, " defined")), import_react.default.createElement("div", {
            style: {
              flex: 1
            }
          }, import_react.default.createElement("canvas", {
          ...
          }), import_react.default.createElement("span", null, " tag")), import_react.default.createElement("div", {
            style: {
              flex: 1
            }
          }, import_react.default.createElement("canvas", {
          ...
          }), import_react.default.createElement("span", null, " empty or undefined"))), import_react.default.createElement("div", {
            style: {
              display: "flex",
              flexDirection: "row",
              marginTop: 10
          ...
          }, import_react.default.createElement("span", null, " MARK_SLOT: ")), import_react.default.createElement("div", {
            style: {
              flex: 1
            }
          }, import_react.default.createElement("canvas", {
          ...
          }), import_react.default.createElement("span", null, " marked")), import_react.default.createElement("div", {
            style: {
              flex: 1
            }
          }, import_react.default.createElement("canvas", {
          ...
          }), import_react.default.createElement("span", null, " unmarked")))));
        }
        return import_react.default.createElement("div", null, import_react.default.createElement("p", null, "This is a visualiser for mark and sweep garbage collector. Check the guide", " ", import_react.default.createElement("a", {
          href: "https://github.com/source-academy/modules/wiki/%5Bcopy_gc-&-mark_sweep%5D-User-Guide"
        }, "here"), "."), import_react.default.createElement("p", null, " Calls the function init() at the end of your code to start. "));
      }
    };
    var MarkSweep_default = {
      toSpawn: () => true,
      body: debuggerContext => import_react.default.createElement(MarkSweep, {
        debuggerContext
      }),
