(function (React) {
    ...
    */
    ...
    var WebGLCanvas=function(_super){__extends(WebGLCanvas,_super);function WebGLCanvas(props){var _this=_super.call(this,props)||this;_this.$canvas=null;_this.onChangeHandler=function(newValue){_this.setState(function(prevState){return __assign(__assign({},prevState),{rotationAngle:newValue,isRotating:false})},function(){if(_this.$canvas){_this.props.context.result.value.redraw(newValue);}});};_this.onClickHandler=function(){if(_this.$canvas&&!_this.state.isRotating){_this.setState(function(prevState){return __assign(__assign({},prevState),{isRotating:true})},function(){_this.autoRotate();});}};_this.autoRotate=function(){if(_this.$canvas&&_this.state.isRotating){var temp_1=_this.state.rotationAngle;_this.setState(function(prevState){return __assign(__assign({},prevState),{rotationAngle:temp_1>=2*Math.PI?0:temp_1+0.005})},function(){_this.props.context.result.value.redraw(_this.state.rotationAngle);window.requestAnimationFrame(_this.autoRotate);});}};_this.state={rotationAngle:0,isRotating:true};return _this}WebGLCanvas.prototype.componentDidMount=function(){if(this.$canvas){this.props.context.result.value.init(this.$canvas);this.autoRotate();}};WebGLCanvas.prototype.render=function(){var _this=this;return React__default['default'].createElement("div",{style:{width:"100%",display:"flex",paddingLeft:"20px",paddingRight:"20px",flexDirection:"column",justifyContent:"center"}},React__default['default'].createElement("canvas",{ref:function(r){_this.$canvas=r;},width:500,height:500}),React__default['default'].createElement("div",{style:{display:"flex",padding:"10px",flexDirection:"row",justifyContent:"space-between",alignItems:"center"}},React__default['default'].createElement(Slider,{value:this.state.rotationAngle,stepSize:0.01,labelValues:[0,2*Math.PI],labelRenderer:false,min:0,max:2*Math.PI,onChange:this.onChangeHandler}),React__default['default'].createElement(Button,{style:{marginLeft:"20px"},onClick:this.onClickHandler},React__default['default'].createElement(Icon,{icon:"play"}))))};return WebGLCanvas}(React__default['default'].Component);var index = {toSpawn:function(context){function isValidFunction(value){try{return value instanceof Object&&value.init instanceof Function}catch(e){return false}}return isValidFunction(context.result.value)},body:function(context){return React__default['default'].createElement(WebGLCanvas,{context:context})},label:"Curves Canvas",iconName:"media"};
