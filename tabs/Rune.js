  ...
  return (() => {
    ...
    var AnimationCanvas = class extends import_react8.default.Component {
      ...
      render() {
        ...
        const animSlider = import_react8.default.createElement("div", {
          style: {
            marginTop: "7px",
            flexGrow: 1
          }
        ...
        }, buttons, animSlider, import_react8.default.createElement(Switch, {
          style: {
            marginLeft: "20px",
            marginRight: "20px",
            marginTop: "5px",
    ...
    function HollusionCanvas({rune}) {
      ...
      return import_react9.default.createElement(webgl_canvas_default, {
        ref: canvasRef
      });
    }
    var Rune_default = {
      toSpawn(context) {
        var _a3, _b2, _c2, _d2;
        const drawnRunes = (_d2 = (_c2 = (_b2 = (_a3 = context.context) == null ? void 0 : _a3.moduleContexts) == null ? void 0 : _b2.rune) == null ? void 0 : _c2.state) == null ? void 0 : _d2.drawnRunes;
      ...
      body(context) {
        ...
        const runeCanvases = drawnRunes.map((rune, i) => {
          ...
          if (glAnimation.isAnimation(rune)) {
            return import_react10.default.createElement(AnimationCanvas, {
              animation: rune,
              key: elemKey
            });
          }
          ...
          if (drawnRune.isHollusion) {
            return import_react10.default.createElement(HollusionCanvas, {
              rune: drawnRune,
              key: elemKey
            });
          }
          return import_react10.default.createElement(webgl_canvas_default, {
            ref: r => {
              if (r) {
                drawnRune.draw(r);
              }
        ...
        return import_react10.default.createElement(multi_item_display_default, {
