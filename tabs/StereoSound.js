(function (_react, ReactDOM) {
  ...
  return (() => {
    ...
    var StereoSound_exports = {};
    __export(StereoSound_exports, {
      default: () => StereoSound_default
    });
    init_define_process();
    ...
    var MultiItemDisplay = props => {
      ...
      }, props.elements.length > 1 ? import_react.default.createElement("div", {
        style: {
          display: "flex",
          justifyContent: "center",
          alignItems: "center",
      ...
      }, "Previous"), import_react.default.createElement("h3", {
        className: "bp3-text-large"
      }, "Call ", currentStep + 1, "/", props.elements.length), import_react.default.createElement(Button, {
        style: {
          position: "absolute",
          right: 0
        },
      ...
      }, "Next")) : null, import_react.default.createElement("div", {
        style: {
          width: "100%",
          paddingLeft: "20px",
          paddingRight: "20px",
    ...
    var StereoSound_default = {
      toSpawn(context) {
        var _a3, _b2, _c2, _d2;
        const audioPlayed = (_d2 = (_c2 = (_b2 = (_a3 = context.context) == null ? void 0 : _a3.moduleContexts) == null ? void 0 : _b2.stereo_sound) == null ? void 0 : _c2.state) == null ? void 0 : _d2.audioPlayed;
        return audioPlayed.length > 0;
      },
      body(context) {
        var _a3;
        const audioPlayed = (_a3 = context.context) == null ? void 0 : _a3.moduleContexts.stereo_sound.state.audioPlayed;
        const elements = audioPlayed.map(audio => import_react2.default.createElement("audio", {
          src: audio.dataUri,
          controls: true,
          id: "sound-tab-player",
          style: {
        ...
        return import_react2.default.createElement("div", null, import_react2.default.createElement("p", {
          id: "sound-default-text"
        }, "The sound tab gives you control over your custom sounds. You can play, pause, adjust the volume and download your sounds.", import_react2.default.createElement("br", null), import_react2.default.createElement("br", null), import_react2.default.createElement(multi_item_display_default, {
          elements
    ...
    return __toCommonJS(StereoSound_exports);
  })()["default"];
})