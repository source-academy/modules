(function (React) {
    ...
    */
    ...
    var PixNFlix=function(_super){__extends(PixNFlix,_super);function PixNFlix(props){var _this=_super.call(this,props)||this;_this.$video=null;_this.$canvas=null;_this.onClickStill=function(){var mode=_this.state.mode;if(mode==="still"){_this.handleSnapPicture();}else {_this.swapModes(mode)();}};_this.setupVideoService=function(){if(_this.$video&&_this.$canvas&&_this.isPixNFlix()){var debuggerContext=_this.props.debuggerContext;_this.pixNFlix=debuggerContext.result.value;var videoProperties=_this.pixNFlix.init(_this.$video,_this.$canvas,_this.printError,{onClickStill:_this.onClickStill});_this.setState({height:videoProperties[0],width:videoProperties[1],FPS:videoProperties[2],useLocalVideo:videoProperties[3]===1});}};_this.closeVideo=function(){if(_this.isPixNFlix()){_this.pixNFlix.deinit();}};_this.handleStartVideo=function(){if(_this.isPixNFlix()){_this.pixNFlix.startVideo();}};_this.handleSnapPicture=function(){if(_this.isPixNFlix()){_this.pixNFlix.snapPicture();}};_this.handleWidthChange=function(width){var height=_this.state.height;_this.handleUpdateDimensions(width,height);};_this.handleHeightChange=function(height){var width=_this.state.width;_this.handleUpdateDimensions(width,height);};_this.handleFPSChange=function(fps){if(fps>=MIN_FPS&&fps<=MAX_FPS){_this.setState({FPS:fps});if(_this.isPixNFlix()){_this.pixNFlix.updateFPS(fps);}}};_this.handleUpdateDimensions=function(w,h){if(w>=MIN_WIDTH&&w<=MAX_WIDTH&&h>=MIN_HEIGHT&&h<=MAX_HEIGHT){_this.setState({width:w,height:h});if(_this.isPixNFlix()){_this.pixNFlix.updateDimensions(w,h);}}};_this.loadFileToVideo=function(file){var useLocalVideo=_this.state.useLocalVideo;if(_this.$video&&useLocalVideo){_this.$video.src=URL.createObjectURL(file);}};_this.handleDrop=function(e){e.preventDefault();_this.loadFileToVideo(e.dataTransfer.files[0]);};_this.handleDragOver=function(e){e.preventDefault();};_this.handleFileUpload=function(e){e.preventDefault();if(e.target&&e.target.files){_this.loadFileToVideo(e.target.files[0]);}};_this.printError=function(){};_this.swapModes=function(mode){return function(){switch(mode){case"video":_this.setState(function(state){return __assign(__assign({},state),{mode:"still"})},_this.handleSnapPicture);break;default:_this.setState(function(state){return __assign(__assign({},state),{mode:"video"})},_this.handleStartVideo);break;}}};_this.handleSwapModes=function(){var mode=_this.state.mode;_this.swapModes(mode)();};_this.state={width:DEFAULT_WIDTH,height:DEFAULT_HEIGHT,FPS:DEFAULT_FPS,useLocalVideo:false,mode:"video"};var debuggerContext=_this.props.debuggerContext;_this.pixNFlix=debuggerContext.result.value;_this.tabsPackage={handleSwapModes:_this.handleSwapModes};return _this}PixNFlix.prototype.componentDidMount=function(){if(this.isPixNFlix()){this.setupVideoService();window.addEventListener("beforeunload",this.pixNFlix.deinit);}};PixNFlix.prototype.componentWillUnmount=function(){if(this.isPixNFlix()){this.closeVideo();window.removeEventListener("beforeunload",this.pixNFlix.deinit);}};PixNFlix.prototype.isPixNFlix=function(){return this.pixNFlix&&this.pixNFlix.toReplString&&this.pixNFlix.toReplString()==="[Pix N Flix]"};PixNFlix.prototype.render=function(){var _this=this;var _a=this.state,mode=_a.mode,width=_a.width,height=_a.height,FPS=_a.FPS,useLocalVideo=_a.useLocalVideo;var videoIsActive=mode==="video";var stillIsActive=mode==="still";return React__default['default'].createElement("div",{className:"sa-video",onDragOver:this.handleDragOver,onDrop:this.handleDrop},React__default['default'].createElement("div",{className:"sa-video-header"},React__default['default'].createElement("div",{className:"sa-video-header-element"},React__default['default'].createElement(ButtonGroup,null,React__default['default'].createElement(Button,{className:"sa-live-video-button",icon:VIDEO,active:videoIsActive,onClick:this.swapModes(mode),text:"Live Video"}),React__default['default'].createElement(Button,{className:"sa-still-image-button",icon:CAMERA,active:stillIsActive,onClick:stillIsActive?this.handleSnapPicture:this.swapModes(mode),text:"Still Image"}))),React__default['default'].createElement(Divider,null),React__default['default'].createElement("div",{className:"sa-video-header-element"},React__default['default'].createElement("div",{className:"sa-video-header-numeric-input"},React__default['default'].createElement(NumericInput,{disabled:true,leftIcon:HORIZONTAL_DISTRIBUTION,style:{width:70},value:width,onValueChange:this.handleWidthChange,minorStepSize:1,stepSize:10,majorStepSize:100,max:MAX_WIDTH,min:MIN_WIDTH})),React__default['default'].createElement("div",{className:"sa-video-header-numeric-input"},React__default['default'].createElement(NumericInput,{disabled:true,leftIcon:VERTICAL_DISTRIBUTION,style:{width:70},value:height,onValueChange:this.handleHeightChange,minorStepSize:1,stepSize:10,majorStepSize:100,max:MAX_HEIGHT,min:MIN_HEIGHT})),React__default['default'].createElement("div",{className:"sa-video-header-numeric-input"},React__default['default'].createElement(NumericInput,{leftIcon:STOPWATCH,style:{width:60},value:FPS,onValueChange:this.handleFPSChange,minorStepSize:null,stepSize:1,majorStepSize:null,max:MAX_FPS,min:MIN_FPS})))),React__default['default'].createElement("div",{className:"sa-video-element"},React__default['default'].createElement("video",{ref:function(r){_this.$video=r;},autoPlay:true,id:"livefeed",width:DEFAULT_WIDTH,height:DEFAULT_HEIGHT,style:{display:"none"}}),React__default['default'].createElement("canvas",{ref:function(r){_this.$canvas=r;},width:DEFAULT_WIDTH,height:DEFAULT_HEIGHT}),React__default['default'].createElement("br",null),React__default['default'].createElement("input",{type:"file",onChange:this.handleFileUpload,style:{display:useLocalVideo?"initial":"none"}}),React__default['default'].createElement("p",{style:{fontFamily:"courier"}},"Note: Is video lagging? Switch to 'still image' or adjust FPS rate!")))};return PixNFlix}(React__default['default'].Component);var index = {toSpawn:function(){return true},body:function(debuggerContext){return React__default['default'].createElement(PixNFlix,{debuggerContext:debuggerContext})},label:"PixNFlix Live Feed",iconName:"mobile-video"};
