  ...
  return (() => {
    ...
    var Divider = (function (_super) {
      ...
      Divider2.prototype.render = function () {
        var _a3 = this.props, className = _a3.className, _b2 = _a3.tagName, tagName = _b2 === void 0 ? "div" : _b2, htmlProps = __rest(_a3, ["className", "tagName"]);
        var classes = (0, import_classnames5.default)(DIVIDER, className);
        return React8.createElement(tagName, __assign(__assign({}, htmlProps), {
          className: classes
        }));
      };
      Divider2.displayName = ("").concat(DISPLAYNAME_PREFIX, ".Divider");
      return Divider2;
    })(AbstractPureComponent2);
    init_define_process();
    ...
    var ControlGroup = (function (_super) {
      ...
      ControlGroup2.prototype.render = function () {
        ...
        var rootClasses = (0, import_classnames6.default)(classes_exports.CONTROL_GROUP, (_a3 = {}, _a3[classes_exports.FILL] = fill, _a3[classes_exports.VERTICAL] = vertical, _a3), className);
        return React9.createElement("div", __assign({}, htmlProps, {
    ...
    var InputGroup = (function (_super) {
      ...
      InputGroup2.prototype.render = function () {
        ...
        var inputGroupClasses = (0, import_classnames7.default)(classes_exports.INPUT_GROUP, classes_exports.intentClass(intent), (_a3 = {}, _a3[classes_exports.DISABLED] = disabled, _a3[classes_exports.FILL] = fill, _a3[classes_exports.LARGE] = large, _a3[classes_exports.SMALL] = small, _a3[classes_exports.ROUND] = round, _a3), className);
        ...
        var inputProps = __assign(__assign({
          ...
          className: classes_exports.INPUT,
          style
        });
        return React11.createElement("div", {
          className: inputGroupClasses
        }, this.maybeRenderLeftElement(), asyncControl ? React11.createElement(AsyncControllableInput, __assign({}, inputProps, {
          inputRef
    ...
    var PixNFlix = class extends import_react.default.Component {
      ...
      render() {
        ...
        return import_react.default.createElement("div", {
        ...
        }, import_react.default.createElement(ButtonGroup, null, import_react.default.createElement(Button, {
          ...
          text: "Pause Video"
        }))), import_react.default.createElement(Divider, null), import_react.default.createElement("div", {
          className: "sa-video-header-element",
          style: {
            display: displayOptions ? "inherit" : "none"
          }
        ...
        }, import_react.default.createElement(NumericInput, {
          disabled: true,
        ...
        }), import_react.default.createElement("br", null), import_react.default.createElement("div", {
          style: {
        ...
        }, "Drag file here"), import_react.default.createElement("br", null), import_react.default.createElement("input", {
          type: "file",
        ...
        }, "Volume:", import_react.default.createElement("input", {
          type: "range",
    ...
    var Pixnflix_default = {
      toSpawn: () => true,
      body: debuggerContext => import_react.default.createElement(PixNFlix, {
        debuggerContext
      }),
