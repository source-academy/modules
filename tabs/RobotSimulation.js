export default require => {
  ...
  var shaderChunkMap = new Map([["encodings_fragment", "colorspace_fragment"], ["encodings_pars_fragment", "colorspace_pars_fragment"], ["output_fragment", "opaque_fragment"]]);
  ...
  function WebGLProgram(renderer, cacheKey, parameters, bindingStates) {
    ...
    if (parameters.isWebGL2 && parameters.isRawShaderMaterial !== true) {
      ...
      prefixFragment = ["precision mediump sampler2DArray;", "#define varying in", parameters.glslVersion === GLSL3 ? "" : "layout(location = 0) out highp vec4 pc_fragColor;", parameters.glslVersion === GLSL3 ? "" : "#define gl_FragColor pc_fragColor", "#define gl_FragDepthEXT gl_FragDepth", "#define texture2D texture", "#define textureCube texture", "#define texture2DProj textureProj", "#define texture2DLodEXT textureLod", "#define texture2DProjLodEXT textureProjLod", "#define textureCubeLodEXT textureLod", "#define texture2DGradEXT textureGrad", "#define texture2DProjGradEXT textureProjGrad", "#define textureCubeGradEXT textureGrad"].join("\n") + "\n" + prefixFragment;
    }
...
void main() {
  ...
  var SimulationCanvas = ({context, isOpen}) => {
    ...
    const [currentState, setCurrentState] = (0, import_react2.useState)("unintialized");
    ...
    return (0, import_jsx_runtime2.jsxs)("div", {
      ...
      children: [(0, import_jsx_runtime2.jsx)("div", {
        ...
        children: (0, import_jsx_runtime2.jsx)(import_core.Tabs, {
          id: "TabsExample"
        })
      })]
    });
  ...
  var TabUi = ({onOpenCanvas}) => {
    return (0, import_jsx_runtime3.jsxs)("div", {
      children: [(0, import_jsx_runtime3.jsx)("p", {
  ...
  var Main = ({context}) => {
    const [isCanvasShowing, setIsCanvasShowing] = (0, import_react3.useState)(false);
    return (0, import_jsx_runtime4.jsxs)("div", {
      children: [(0, import_jsx_runtime4.jsx)(TabUi, {
        onOpenCanvas: () => {
          setIsCanvasShowing(true);
        }
      }), (0, import_jsx_runtime4.jsx)(Modal, {
        isOpen: isCanvasShowing,
        onClose: () => {
          setIsCanvasShowing(false);
        },
        children: (0, import_jsx_runtime4.jsx)(SimulationCanvas, {
          context,
          isOpen: isCanvasShowing
        })
      })]
  ...
  var RobotSimulation_default = {
    ...
    body: context => (0, import_jsx_runtime5.jsx)(Main, {
      context
    }),
    label: "Sample Tab",
    iconName: "build"
