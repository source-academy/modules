...
// Values extracted from BlueprintJS V4
export const BP_TAB_BUTTON_MARGIN: string = '20px';
export const BP_TAB_PANEL_MARGIN: string = '20px';
export const BP_CARD_BORDER_RADIUS: string = '2px';
export const BP_TEXT_MARGIN: string = '10px';

export const BP_TEXT_COLOR: string = '#FFFFFF';
