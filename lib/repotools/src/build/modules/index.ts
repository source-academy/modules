...
import type { BuildDiagnostic, ResolvedBundle, ResolvedTab } from '../../types.js';
...
export async function buildBundle(outDir: string, bundle: ResolvedBundle, watch: false): Promise<BuildDiagnostic>;
...
export async function buildTab(outDir: string, tab: ResolvedTab, watch: false): Promise<BuildDiagnostic>;
