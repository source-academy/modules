...
export function directoryCreator(directory, options = {}) {
    ...
    function* recurser(srcDir, basename, indent) {
...
export function directoryTreePlugin(md, options = {}) {
